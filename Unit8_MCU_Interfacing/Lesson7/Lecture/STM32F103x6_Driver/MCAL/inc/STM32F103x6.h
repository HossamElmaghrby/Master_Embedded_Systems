...
//Disable clock
#define RCC_PSI1_CLK_DI()   (RCC->APB2RSTR |= 1 << 12)
#define RCC_PSI2_CLK_DI()   (RCC->APB1RSTR |= 1 << 14)
...
//Disable clock
#define RCC_I2C1_CLK_DI()	(RCC->APB1RSTR |= 1 << 21)
#define RCC_I2C2_CLK_DI()	(RCC->APB1RSTR |= 1 << 22)
//-*-*-*-*-*-*-*-*-*-*-*-
...
#define NVIC_IRQ35_SPI1_DI()			(NVIC_ICER1 |= 1<<(SPI1_IRQ - 32))
#define NVIC_IRQ35_SPI2_DI()			(NVIC_ICER1 |= 1<<(SPI2_IRQ - 32))

#define NVIC_IRQ31_I2C1_EV_DI()			(NVIC_ICER0 |= 1<<(I2C1_EV_IRQ))
#define NVIC_IRQ32_I2C1_ER_DI()			(NVIC_ICER1 |= 1<<(I2C1_ER_IRQ - 32))
#define NVIC_IRQ33_I2C2_EV_DI()			(NVIC_ICER1 |= 1<<(I2C2_EV_IRQ - 32))
#define NVIC_IRQ34_I2C2_ER_DI()			(NVIC_ICER1 |= 1<<(I2C2_ER_IRQ - 32))
